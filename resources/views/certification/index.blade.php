...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('certification.create') }}" class="btn btn-primary">Create New Certification</a>
</div>
            ...
            @foreach($certifications as $certification)
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('certification.destroy', $certification->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
