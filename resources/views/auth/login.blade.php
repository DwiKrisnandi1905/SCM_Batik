                        ...
                        <div class="col-lg-6">
                            <div class="card-body p-md-3 mx-md-4">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="text-center">
                                        <button data-mdb-button-init data-mdb-ripple-init class="btn btn-custom btn-block fa-lg mb-3" type="submit">Log in</button>
                                    </div>

                                    <div class="d-flex align-items-center justify-content-center">
                                        <p class="mb-0 me-2">Don't have an account?</p>
                                        <a href="{{ route('register') }}" class="btn btn-outline-custom" data-mdb-button-init data-mdb-ripple-init>Register</a>
                                    </div>
