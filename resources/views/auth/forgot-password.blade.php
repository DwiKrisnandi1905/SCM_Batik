                        ...
                        <div class="col-lg-6">
                            <div class="card-body p-md-3 mx-md-4">
                                <div class="text-center">
                                    ...
                                    <h4 class="mt-4 mb-4 pb-1">Forgot Password</h4>
                                </div>
                                ...
                                <form action="{{ route('password.forgot.email') }}" method="POST">
                                    ...
                                    <div class="text-center">
                                        <button data-mdb-button-init data-mdb-ripple-init class="btn btn-custom btn-block fa-lg mb-3" type="submit">Send Reset Link</button>
                                    </div>
                                </form>
